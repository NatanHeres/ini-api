...
document.addEventListener('DOMContentLoaded', () => {
 ...
 $(document).ready(function () {
  ...
  var companyName = '<a href="https://api.clayzaaubert.my.id" target="_blank" title="css templates">Aubertify Rest Api</a>';
  var author = '<a href="https://clayzaaubert.my.id" target="_blank" title="css templates">Clayza Aubert</a>';
