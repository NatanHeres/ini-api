function getvisitors() {
	...
	var url = "https://api.countapi.xyz/hit/api.clayzaaubert.my.id/visitors";
...
function formatPremiumTime(timestamp) {
    return moment(timestamp).format('MMMM Do YYYY, h:mm a');
  }
  
// User Login
$.getJSON("https://api.countapi.xyz/hit/api.clayzaaubert.my.id/userlogin", function(response) {
    $("#userlogin").text(response.value);
})

// Request Today
$.getJSON("https://api.countapi.xyz/hit/api.clayzaaubert.my.id/requesttoday", function(response) {
    $("#requesttoday").text(response.value);
})

// Total Request
$.getJSON("https://api.countapi.xyz/hit/api.clayzaaubert.my.id/totalrequest", function(response) {
